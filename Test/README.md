...
Usage:
1. Copy the following files to the same directory: <code>run_regression.py</code> (test main), <code>ELTpupil_sttusReporting.py</code> (python main), <code>anisocado_pupUtils.py</code> (python libs), <code>elt_pupil_status</code> (C executable).
