...
4. Script creates N xml files to a temporary directory, creates FITS files with N_0 and compares them, then deletes FITS files, continues same with N_1, and repeats to N.
