...
3. Adjust test parameters inside run_regression.py
...
5. Script creates N xml files to a temporary directory, creates FITS files with N_0 and comapares, deletes FITS files, continues with same with N_1, and repeats to N.
6. Results are saved as "regression_log.txt"
